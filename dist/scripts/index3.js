{
  class Details {
    constructor() {
      ...
      const detailsTmpl = `
            ...
            <button class="details__addtocart">view</button>
  ...
  class Item {
    constructor(el) {
      this.DOM = {};
      this.DOM.el = el;
      this.DOM.product = this.DOM.el.querySelector(".product2");
      this.DOM.productBg = this.DOM.product.querySelector(".product__bg2");
      this.DOM.productImg = this.DOM.product.querySelector(".product__img2");

      this.info = {
        img: this.DOM.productImg.src,
        title: this.DOM.product.querySelector(".product__title2").innerHTML,
        subtitle: this.DOM.product.querySelector(".product__subtitle2")
          .innerHTML,
        description: this.DOM.product.querySelector(".product__description2")
          .innerHTML,
        price: this.DOM.product.querySelector(".product__price2").innerHTML,
      };
  ...
  DOM.gridItems = Array.from(DOM.grid.querySelectorAll(".grid__item2"));
  let items = [];
