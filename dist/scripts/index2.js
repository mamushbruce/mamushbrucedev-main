!(function () {
     ...
     */ var i,
        ...
        te = function t(e, r) {
            ...
            return N(r) && (isNaN(r) || r in s)
                ? "<" === (i = r.charAt(0)) || ">" === i
                    ? ("<" === i ? o._start : o.endTime(o._repeat >= 0)) + (parseFloat(r.substr(1)) || 0)
                    : (i = r.indexOf("=")) < 0
                    ? (r in s || (s[r] = a), s[r])
                    : ((n = +(r.charAt(i - 1) + r.substr(i + 1))), i > 1 ? t(e, r.substr(0, i - 1)) + n : a + n)
                : null == r
                ? a
                : +r;
        },
        ...
        ue = function (t) {
            ...
            var e = U(t) ? t : { each: t },
                ...
                l = i;
            return (
                N(i) ? (h = l = { center: 0.5, edges: 0.5, end: 1 }[i] || 0) : !o && a && ((h = i[0]), (l = i[1])),
                function (t, o, c) {
                    var f,
                        d,
                        p,
                    ...
                    if (!b) {
                        ...
                        for (b = s[x] = [], f = a ? Math.min(w, x) * h - 0.5 : i % w, d = a ? (x * l) / w - 0.5 : (i / w) | 0, v = 0, y = I, g = 0; g < x; g++)
                            (p = (g % w) - f), (m = d - ((g / w) | 0)), (b[g] = _ = u ? Math.abs("y" === u ? m : p) : q(p * p + m * m)), _ > v && (v = _), _ < y && (y = _);
                        "random" === i && ae(b),
                            (b.max = v - y),
                            (b.min = y),
                            (b.v = x = (parseFloat(e.amount) || parseFloat(e.each) * (w > x ? x - 1 : u ? ("y" === u ? x / w : w) : Math.max(w, x / w)) || 0) * ("edges" === i ? -1 : 1)),
                            (b.b = x < 0 ? n - x : n),
        ...
        le = function (t, e) {
            var r,
                ...
                n = $(t);
            return (
                !n && U(t) && ((r = n = t.radius || I), t.values ? ((t = oe(t.values)), (i = !X(t[0])) && (r *= r)) : (t = he(t.increment))),
                ee(
                    e,
                    n
                        ? V(t)
                            ...
                            : function (e) {
                                  for (var n, s, o = parseFloat(i ? e.x : e), a = parseFloat(i ? e.y : 0), u = I, h = 0, l = t.length; l--; )
                                      (n = i ? (n = t[l].x - o) * n + (s = t[l].y - a) * s : Math.abs(t[l] - o)) < u && ((u = n), (h = l));
        ...
        de = function (t) {
            for (var e, r, i, n, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
                (i = t.indexOf(")", e)), (n = "[" === t.charAt(e + 7)), (r = t.substr(e + 7, i - e - 7).match(n ? rt : Z)), (o += t.substr(s, e - s) + ce(n ? r : +r[0], n ? 0 : +r[1], +r[2] || 1e-5)), (s = i + 1);
            ...
            var e = (t = (!t.name && t.default) || t).name,
                ...
                i =
                    e && !r && t.init
                        ...
                        : t,
                n = { init: lt, render: ar, add: We, kill: hr, modifier: ur, rawVars: 0 },
        ...
        xe = function (t, e, r) {
            return ((6 * (t = t < 0 ? t + 1 : t > 1 ? t - 1 : t) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e) * ye + 0.5) | 0;
        },
        be = function (t, e, r) {
            var i,
                n,
            ...
            if (!d) {
                if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), we[t])) d = we[t];
                    ...
                    if ((t.length < 6 && ((i = t.charAt(1)), (n = t.charAt(2)), (s = t.charAt(3)), (t = "#" + i + i + n + n + s + s + (5 === t.length ? t.charAt(4) + t.charAt(4) : ""))), 9 === t.length))
                        return [(d = parseInt(t.substr(1, 6), 16)) >> 16, (d >> 8) & ye, d & ye, parseInt(t.substr(7), 16) / 255];
                    ...
                    if (((d = f = t.match(Z)), e)) {
                        ...
                        (o = (+d[0] % 360) / 360),
                            (a = +d[1] / 100),
                            (i = 2 * (u = +d[2] / 100) - (n = u <= 0.5 ? u * (a + 1) : u + a - u * a)),
                            d.length > 3 && (d[3] *= 1),
                            (d[0] = xe(o + 1 / 3, i, n)),
                            (d[1] = xe(o, i, n)),
                            (d[2] = xe(o - 1 / 3, i, n));
            ...
            return (
                e &&
                    ...
                    h === l ? (o = a = 0) : ((c = h - l), (a = u > 0.5 ? c / (2 - h - l) : c / (h + l)), (o = h === i ? (n - s) / c + (n < s ? 6 : 0) : h === n ? (s - i) / c + 2 : (i - n) / c + 4), (o *= 60)),
                    (d[0] = ~~(o + 0.5)),
                    (d[1] = ~~(100 * a + 0.5)),
                    (d[2] = ~~(100 * u + 0.5))),
                r && d.length < 4 && (d[3] = 1),
        ...
        Te = function (t, e, r) {
            ...
            if (!n) for (o = (n = t.split(Me)).length - 1; l < o; l++) a += n[l] + u[l];
            return a + n[o];
        },
        Me = (function () {
            var t,
            ...
            (m = {
                ...
                wake: function () {
                    u &&
                        (!o &&
                            H() &&
                            ((s = o = window), (a = s.document || {}), (nt.gsap = _r), (s.gsapVersions || (s.gsapVersions = [])).push(_r.version), ot(st || s.GreenSockGlobals || (!s.gsap && s) || {}), (p = s.requestAnimationFrame)),
                        f && m.sleep(),
                        (d =
                            p ||
                            function (t) {
        ...
        Ie = function (t) {
            for (var e, r, i, n = {}, s = t.substr(1, t.length - 3).split(":"), o = s[0], a = 1, u = s.length; a < u; a++)
                (r = s[a]), (e = a !== u - 1 ? r.lastIndexOf(",") : r.length), (i = r.substr(0, e)), (n[o] = isNaN(i) ? i.replace(Le, "").trim() : +i), (o = r.substr(e + 1).trim());
            return n;
        },
        Pe = function (t) {
            return function (e) {
                        ...
                        : Ae[t] ||
                          (function (t) {
                              ...
                              return o && s.length > 1 && o.config
                                  ? o.config.apply(
                                        null,
                                        ~t.indexOf("{") ? [Ie(s[1])] : ((e = t), (r = e.indexOf("(") + 1), (i = e.indexOf(")")), (n = e.indexOf("(", r)), e.substring(r, ~n && n < i ? e.indexOf(")", i + 1) : i)).split(",").map(kt)
                                    )
                                  : Ae._CE && Ce.test(t)
                                  ? Ae._CE("", t)
                                  : o;
    ...
    bt("Linear,Quad,Cubic,Quart,Quint,Strong", function (t, e) {
        ...
        Fe(
            ...
            (A = function (t) {
                return t < E ? S * t * t : t < 0.7272727272727273 ? S * Math.pow(t - 1.5 / k, 2) + 0.75 : t < 0.9090909090909092 ? S * (t -= 2.25 / k) * t + 0.9375 : S * Math.pow(t - 2.625 / k, 2) + 0.984375;
            })
        ),
        Fe("Expo", function (t) {
        ...
        (Ae.SteppedEase = Ae.steps = nt.SteppedEase = {
            config: function (t, e) {
                void 0 === t && (t = 1);
                var r = 1 / t,
                    i = t + (e ? 0 : 1),
                    ...
                    return arguments.length
                        ? (this._ps !== t &&
                              ...
                              t
                                  ...
                                  : (Ee(),
                                    (this._ts = this._rts),
                                    this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= P) && Math.abs(this._zTime) !== P))),
                          this)
                        : this._ps;
                }),
    ...
    At(Ve.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -1e-8, _prom: 0, _ps: !1, _rts: 1 });
    var Xe = (function (t) {
        function i(r, i) {
            var n;
            return (
        ...
        return (
            ...
            (s.render = function (t, e, r) {
                ...
                if (y !== this._tTime || r || w) {
                    if ((_ !== this._time && v && ((y += this._time - _), (t += this._time - _)), (i = y), (f = this._start), (h = !(c = this._ts)), w && (v || (_ = this._zTime), (t || !e) && (this._zTime = t)), this._repeat)) {
                        ...
                        if (
                            ((i = Ot(y % u)),
                            y === g ? ((a = this._repeat), (i = v)) : ((a = ~~(y / u)) && a === y / u && ((i = v), a--), i > v && (i = v)),
                            (d = Vt(this._tTime, u)),
                    ...
                    this._onUpdate && !e && _e(this, "onUpdate", !0),
                        ((y === g && g >= this.totalDuration()) || (!y && _)) &&
                            ((f !== this._start && Math.abs(c) === Math.abs(this._ts)) ||
                                ...
                                e || (t < 0 && !_) || (!y && !_) || (_e(this, y === g ? "onComplete" : "onReverseComplete", !0), this._prom && !(y < g && this.timeScale() > 0) && this._prom())));
                }
                return this;
            }),
            (s.add = function (t, e) {
            ...
            (s.totalTime = function (e, r) {
                return arguments.length
                    ? ((this._forcing = 1), !this._dp && this._ts && (this._start = Ot(ke.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))), t.prototype.totalTime.call(this, e, r), (this._forcing = 0), this)
                    : this._tTime;
            }),
            ...
            (s.getTweensOf = function (t, e) {
                for (var r, i = [], n = oe(t), s = this._first, o = X(e); s; )
                    s instanceof Je
                        ? Tt(s._targets, n) && (o ? (!Ye || (s._initted && s._ts)) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && i.push(s)
                ...
                if (o._dirty) {
                    for (i = o.parent; a; )
                        (e = a._prev),
                            ...
                            (r = a._start) > u && o._sort && a._ts && !o._lock ? ((o._lock = 1), (Ht(o, a, r - a._delay, 1)._lock = 0)) : (u = r),
                            r < 0 && a._ts && ((s -= r), ((!i && !o._dp) || (i && i.smoothChildTiming)) && ((o._start += r / o._ts), (o._time -= r), (o._tTime -= r)), o.shiftChildren(-r, !1, -Infinity), (u = 0)),
    ...
    var Ye,
        Ue = function (t, e, r, i, n, s, o) {
            var a,
                ...
                _ = 0,
                g = 0;
            for (m.b = r, m.e = i, r += "", (d = ~(i += "").indexOf("random(")) && (i = de(i)), s && (s((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(tt) || []; (a = tt.exec(i)); )
                (l = a[0]),
                    (c = i.substring(_, a.index)),
                    h ? (h = (h + 1) % 5) : "rgba(" === c.substr(-5) && (h = 1),
                    l !== u[g++] &&
                        ((f = parseFloat(u[g - 1]) || 0),
                        (m._pt = { _next: m._pt, p: c || 1 === g ? c : ",", s: f, c: "=" === l.charAt(1) ? parseFloat(l.substr(2)) * ("-" === l.charAt(0) ? -1 : 1) : parseFloat(l) - f, m: h && h < 4 ? Math.round : 0 }),
                        (_ = tt.lastIndex));
        ...
        We = function (t, e, r, i, n, s, o, a, u) {
            ...
            var h,
                ...
                f = V(l) ? (u ? er : tr) : Ke;
            if ((N(i) && (~i.indexOf("random(") && (i = de(i)), "=" === i.charAt(1) && (i = parseFloat(c) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (ie(c) || 0))), c !== i))
                return isNaN(c * i)
                    ? (!l && !(e in t) && at(e, i), Ue.call(this, t, e, c, i, f, a || C.stringFilter, u))
                    : ((h = new fr(this._pt, t, e, +c || 0, i - (c || 0), "boolean" == typeof l ? sr : nr, 0, f)), u && (h.fp = u), o && h.modifier(o, this, t), (this._pt = h));
        },
        He = function (t, e, r, i, n, s) {
            ...
            if (
                ...
                ((r._pt = a = new fr(r._pt, n, t, 0, 1, o.render, o, 0, o.priority)), r !== l)
            )
        ...
        Qe = function t(e, r) {
            ...
            if ((q && (!k || !y) && (y = "none"), (e._ease = ze(y, L.ease)), (e._yEase = S ? Pe(ze(!0 === S ? y : S, L.ease)) : 0), S && e._yoyo && !e._repeat && ((S = e._yEase), (e._yEase = e._ease), (e._ease = S)), !q)) {
                if (((_ = (f = I[0] ? wt(I[0]).harness : 0) && v[f.prop]), (s = Pt(v, ct)), C && C.render(-1, !0).kill(), w))
                    if ((Ft((e._startAt = Je.set(I, At({ data: "isStart", overwrite: !1, parent: R, immediateRender: !0, lazy: W(b), startAt: null, delay: 0, onUpdate: O, onUpdateParams: T, callbackScope: M, stagger: 0 }, w)))), x)) {
                        if (r > 0) E || (e._startAt = 0);
                        else if (A && !(r < 0 && C)) return void (r && (e._zTime = r));
                    } else !1 === E && (e._startAt = 0);
                else if (D && A)
                    if (C) !E && (e._startAt = 0);
                    else if ((r && (x = !1), (a = At({ overwrite: !1, data: "isFromStart", lazy: x && W(b), immediateRender: x, stagger: 0, parent: R }, s)), _ && (a[f.prop] = _), Ft((e._startAt = Je.set(I, a))), x)) {
                        if (!r) return;
                    } else t(e._startAt, P);
                for (e._pt = 0, b = (A && W(b)) || (b && !A), o = 0; o < I.length; o++) {
                    if (
                        ...
                        f &&
                            ...
                            ((e._pt = u = new fr(e._pt, h, d.name, 0, 1, d.render, d, 0, d.priority)),
        ...
        Je = (function (t) {
            function s(r, s, o, a) {
                ...
                if (((u._targets = k.length ? yt(k) : ut("GSAP target " + r + " not found. https://greensock.com", !C.nullTargetWarn) || []), (u._ptLookup = []), (u._overwrite = b), O || x || Q(v) || Q(y))) {
                    if (((s = u.vars), (h = u.timeline = new Xe({ data: "nested", defaults: T || {} })).kill(), (h.parent = h._dp = e(u)), (h._start = 0), O))
                        At(h.vars.defaults, { ease: "none" }),
                            O.forEach(function (t) {
                                return h.to(k, t, ">");
                            });
                    else {
                        if (((f = k.length), (m = x ? ue(x) : lt), U(x))) for (d in x) ~$e.indexOf(d) && (_ || (_ = {}), (_[d] = x[d]));
                        for (l = 0; l < f; l++) {
                            ...
                            (c.stagger = 0),
                                ...
                                !x && 1 === f && c.delay && ((u._delay = y = c.delay), (u._start += y), (c.delay = 0)),
                                h.to(p, c, m(l, p, k));
                        }
                ...
                return (
                    ...
                    S && Wt(S, e(u)),
                    (w || (!v && !O && u._start === Ot(S._time) && W(w) && jt(e(u)) && "nested" !== S.data)) && ((u._tTime = -1e-8), u.render(Math.max(0, -y))),
                    M && Qt(e(u), M),
                    u
                );
            }
            ...
            return (
                    ...
                    if (p) {
                        if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
                            if (((i = m), (l = this.timeline), this._repeat)) {
                                ...
                                if (
                                    ((i = Ot(m % o)),
                                    m === d ? ((s = this._repeat), (i = p)) : ((s = ~~(m / o)) && s === m / o && ((i = p), s--), i > p && (i = p)),
                            ...
                            (l && l.render(t < 0 ? t : !i && u ? -1e-8 : l._dur * h, e, r)) || (this._startAt && (this._zTime = t)),
                                ...
                                (m !== this._tDur && m) ||
                                    ...
                                    e || (t < 0 && !f) || (!m && !f) || (_e(this, m === d ? "onComplete" : "onReverseComplete", !0), this._prom && !(m < d && this.timeScale() > 0) && this._prom()));
                        }
                    } else
                        !(function (t, e, r, i) {
                            var n,
                                ...
                                l = 0;
                            if (
                                (h && t._repeat && ((l = re(0, t._tDur, e)), (s = Vt(l, h)), (o = Vt(t._tTime, h)), t._yoyo && 1 & s && (u = 1 - u), s !== o && ((a = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
                                ...
                                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                                    ...
                                    (e >= t._tDur || e < 0) && t.ratio === u && (u && Ft(t, 1), r || (_e(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
                ...
                (o.kill = function (t, e) {
                    ...
                    for (
                            ...
                            "all" !== e &&
                                ...
                                (e = (function (t, e) {
                                    var r,
                                        ...
                                        a = o && o.aliases;
                                    if (!a) return e;
                                    for (i in ((r = Lt({}, e)), a)) if ((i in r)) for (n = (s = a[i].split(",")).length; n--; ) r[s[n]] = r[i];
                                    return r;
                                })(l, e))),
                            h = l.length;
                        h--;
                        ...
                        if (~c.indexOf(l[h]))
                            for (a in ((n = f[h]), "all" === e ? ((i[h] = e), (o = n), (s = {})) : ((s = i[h] = i[h] || {}), (o = e)), o))
                                (u = n && n[a]) && (("kill" in u.d && !0 !== u.d.kill(a)) || zt(this, u, "_pt"), delete n[a]), "all" !== s && (s[a] = 1);
    ...
    bt(
        ...
        (n = new Xe({ sortChildren: !1, defaults: L, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
        (C.stringFilter = Se);
    var dr = {
        ...
        exportRoot: function (t, e) {
            ...
            var r,
                i,
                s = new Xe(t);
            for (s.smoothChildTiming = W(t.smoothChildTiming), n.remove(s), s._dp = 0, s._time = s._tTime = n._time, r = n._first; r; )
                (i = r._next), (!e && !r._dur && r instanceof Je && r.vars.onComplete === r._targets[0]) || Ht(s, r, r._start - r._delay), (r = i);
            return Ht(n, s, 0), s;
        },
        utils: {
                    ...
                    i._onInit = function (t) {
                        ...
                        !(function (t, e) {
                            var r,
                                ...
                                n,
                                s = t._targets;
                            for (r in e) for (i = s.length; i--; ) (n = t._ptLookup[i][r]) && (n = n.d) && (n._pt && (n = pr(n, r)), n && n.modifier && n.modifier(e[r], t, s[i], r));
                        })(t, r);
                    };
                },
            };
    ...
    var gr,
        ...
        Zr = function t(e) {
            var r,
                i = Wr("svg", (this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns")) || "http://www.w3.org/2000/svg"),
                n = this.parentNode,
                s = this.nextSibling,
        ...
        Kr = function (t) {
            ...
            return (e && (e.width || e.height)) || t.getBBox === Zr || (e = Zr.call(t, !0)), !e || e.width || e.x || e.y ? e : { x: +Jr(t, ["x", "cx", "x1"]) || 0, y: +Jr(t, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
        },
        ti = function (t) {
                ...
                : ("px" !== l && !_ && (h = t(e, r, i, "px")),
                  ...
                  (!g && "%" !== l) || (!Tr[r] && !~r.indexOf("adius"))
                      ? ((c[f ? "width" : "height"] = m + (_ ? l : n)),
                        (o = ~r.indexOf("adius") || ("em" === n && e.appendChild && !d) ? e : e.parentNode),
                      ...
                      : ((s = u ? e.getBBox()[f ? "width" : "height"] : e[p]), Ot(g ? (h / s) * m : (h / 100) * s)));
        },
        si = function (t, e, r, i) {
            var n;
            return (
                ...
                Tr[e] && "transform" !== e
                    ? ((n = _i(t, i)), (n = "transformOrigin" !== e ? n[e] : gi(Hr(t, Ur)) + " " + n.zOrigin + "px"))
                    : (!(n = t.style[e]) || "auto" === n || i || ~(n + "").indexOf("calc(")) && (n = (hi[e] && hi[e](t, e, r)) || Hr(t, e) || xt(t, e) || ("opacity" === e ? 1 : 0)),
                ...
                for (; (a = K.exec(i)); )
                    (f = a[0]),
                        ...
                        f !== (c = u[w++] || "") &&
                            ...
                            m || ((m = m || C.units[e] || _), y === i.length && ((i += m), (v.e += m))),
                            _ !== m && (h = ni(t, e, c, m) || 0),
                            (v._pt = { _next: v._pt, p: p || 1 === w ? p : ",", s: h, c: g ? g * d : d - h, m: (l && l < 4) || "zIndex" === e ? Math.round : 0 }));
        ...
        ui = function (t, e) {
            if (e.tween && e.tween._time === e.tween._dur) {
                ...
                else for (n = (a = a.split(",")).length; --n > -1; ) (r = a[n]), Tr[r] && ((i = 1), (r = "transformOrigin" === r ? Ur : Yr)), ei(s, r);
        ...
        pi = function (t, e) {
            ...
            return o.svg && t.getAttribute("transform")
                ...
                : (u !== li ||
                      ...
                      ((n = a.display),
                      (a.display = "block"),
                      ((r = t.parentNode) && t.offsetParent) || ((s = 1), (i = t.nextSibling), yr.appendChild(t)),
                      (u = di(t)),
        ...
        mi = function (t, e, r, i, n, s) {
            var o,
                ...
                O = parseFloat(x[1]) || 0;
            r
                ? l !== li && (a = m * v - _ * g) && ((u = b * (-_ / a) + O * (m / a) - (m * w - _ * y) / a), (b = b * (v / a) + O * (-g / a) + (g * w - v * y) / a), (O = u))
                : ((b = (o = Kr(t)).x + (~x[0].indexOf("%") ? (b / 100) * o.width : b)), (O = o.y + (~(x[1] || x[0]).indexOf("%") ? (O / 100) * o.height : O))),
                i || (!1 !== i && h.smooth) ? ((y = b - c), (w = O - f), (h.xOffset = d + (y * m + w * g) - y), (h.yOffset = p + (y * _ + w * v) - w)) : (h.xOffset = h.yOffset = 0),
                (h.xOrigin = b),
                (h.yOrigin = O),
                (h.smooth = !!i),
                (h.origin = e),
                ...
                (t.style[Ur] = "0px 0px"),
                s && (ri(s, h, "xOrigin", c, b), ri(s, h, "yOrigin", f, O), ri(s, h, "xOffset", d, h.xOffset), ri(s, h, "yOffset", p, h.yOffset)),
        ...
        _i = function (t, e) {
            ...
            return (
                ...
                (r.svg = !(!t.getCTM || !ti(t))),
                (_ = pi(t, r.svg)),
                r.svg && ((D = !r.uncache && !e && t.getAttribute("data-svg-origin")), mi(t, D || j, !!D || r.originIsAbsolute, !1 !== r.smooth, _)),
                (p = r.xOrigin || 0),
                (m = r.yOrigin || 0),
                _ !== li &&
                    ((w = _[0]),
                    ...
                    6 === _.length
                        ? ((o = Math.sqrt(w * w + x * x)),
                          (a = Math.sqrt(O * O + b * b)),
                          (u = w || x ? Sr(x, w) * Mr : 0),
                          (c = b || O ? Sr(b, O) * Mr + u : 0) && (a *= Math.abs(Math.cos(c * Dr))),
                        ...
                        : ((R = _[6]),
                          ...
                          g &&
                              ...
                              (R = k)),
                          (l = (g = Sr(-b, L)) * Mr),
                          g && ((v = Math.cos(-g)), (P = O * (y = Math.sin(-g)) + P * v), (w = D = w * v - E * y), (x = S = x * v - A * y), (b = k = b * v - L * y)),
                          (u = (g = Sr(x, w)) * Mr),
                          g && ((D = w * (v = Math.cos(g)) + x * (y = Math.sin(g))), (S = T * v + M * y), (x = x * v - w * y), (M = M * v - T * y), (w = D), (T = S)),
                          ...
                          (d = P ? 1 / (P < 0 ? -P : P) : 0)),
                    r.svg && ((D = t.getAttribute("transform")), (r.forceCSS = t.setAttribute("transform", "") || !fi(Hr(t, Yr))), D && t.setAttribute("transform", D))),
                Math.abs(c) > 90 && Math.abs(c) < 270 && (F ? ((o *= -1), (c += u <= 0 ? 180 : -180), (u += u <= 0 ? 180 : -180)) : ((a *= -1), (c += c <= 0 ? 180 : -180))),
                (r.x = i - ((r.xPercent = i && (r.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-i) ? -50 : 0))) ? (t.offsetWidth * r.xPercent) / 100 : 0) + q),
                (r.y = n - ((r.yPercent = n && (r.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0))) ? (t.offsetHeight * r.yPercent) / 100 : 0) + q),
                (r.z = s + q),
                (r.scaleX = Ot(o)),
                (r.scaleY = Ot(a)),
                (r.rotation = Ot(u) + B),
        ...
        Oi = function (t, e) {
            ...
            m !== xi && (y += "perspective(" + m + bi),
                (i || n) && (y += "translate(" + i + "%, " + n + "%) "),
                (w || s !== xi || o !== xi || a !== xi) && (y += a !== xi || w ? "translate3d(" + s + ", " + o + ", " + a + ") " : "translate(" + s + ", " + o + bi),
                u !== wi && (y += "rotate(" + u + bi),
                h !== wi && (y += "rotateY(" + h + bi),
                l !== wi && (y += "rotateX(" + l + bi),
            ...
            (f = parseFloat(f)),
                ...
                f || d
                    ? ((f *= Dr),
                      ...
                      (n = Math.sin(f - d) * -_),
                      (s = Math.cos(f - d) * _),
                      d && ((p *= Dr), (o = Math.tan(d - p)), (n *= o = Math.sqrt(1 + o * o)), (s *= o), p && ((o = Math.tan(p)), (r *= o = Math.sqrt(1 + o * o)), (i *= o))),
                      (r = Ot(r)),
                      (i = Ot(i)),
                      (n = Ot(n)),
                      (s = Ot(s)))
                    : ((r = m), (s = _), (i = n = 0)),
                ((O && !~(l + "").indexOf("px")) || (T && !~(c + "").indexOf("px"))) && ((O = ni(g, "x", l, "px")), (T = ni(g, "y", c, "px"))),
                (v || y || w || x) && ((O = Ot(O + v - (v * r + y * n) + w)), (T = Ot(T + y - (v * i + y * s) + x))),
                (u || h) && ((o = g.getBBox()), (O = Ot(O + (u / 100) * o.width)), (T = Ot(T + (h / 100) * o.height))),
                (o = "matrix(" + r + "," + i + "," + n + "," + s + "," + O + "," + T + ")"),
        ...
        Si = function (t, e, r) {
            var i,
                ...
                c = r.style;
            for (n in (l.svg
                ? ((s = r.getAttribute("transform")), r.setAttribute("transform", ""), (c[Yr] = e), (i = _i(r, 1)), ei(r, Yr), r.setAttribute("transform", s))
                : ((s = getComputedStyle(r)[Yr]), (c[Yr] = e), (i = _i(r, 1)), (c[Yr] = s)),
            Tr))
                (s = l[n]) !== (o = i[n]) &&
                    "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 &&
                    ((a = ie(s) !== (h = ie(o)) ? ni(r, n, s, h) : parseFloat(s)), (u = parseFloat(o)), (t._pt = new fr(t._pt, i, n, a, u - a, Lr)), (t._pt.u = h || 0), t._props.push(n));
            Di(i, l);
        };
    ...
    var ki,
        ...
        Ci = {
                ...
                for (c in (wr || $r(), e))
                    if ("autoRound" !== c && ((o = e[c]), !pt[c] || !He(c, e, r, i, t, n)))
                        if (((h = typeof o), (l = hi[c]), "function" === h && (h = typeof (o = o.call(r, i, t, n))), "string" === h && ~o.indexOf("random(") && (o = de(o)), l)) l(this, t, c, o, r) && (y = 1);
                            ...
                            if (
                                (D && c in D ? ((s = "function" == typeof D[c] ? D[c].call(r, i, t, n) : D[c]), c in C.units && !ie(s) && (s += C.units[c]), "=" === (s + "").charAt(1) && (s = si(t, c))) : (s = si(t, c)),
                                (u = parseFloat(s)),
                                (p = "string" === h && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) && (o = o.substr(2)),
                                (a = parseFloat(o)),
                                c in Cr &&
                                    ("autoAlpha" === c && (1 === u && "hidden" === si(t, "visibility") && a && (u = 0), ri(this, M, "visibility", u ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)),
                                    "scale" !== c && "transform" !== c && ~(c = Cr[c]).indexOf(",") && (c = c.split(",")[0])),
                                (m = c in Tr))
                            )
                                if (
                                    (_ ||
                                        (((g = t._gsap).renderTransform && !e.parseTransform) || _i(t, e.parseTransform),
                                        (v = !1 !== e.smoothOrigin && g.smooth),
                                        ((_ = this._pt = new fr(this._pt, M, Yr, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                                    "scale" === c)
                                )
                                    (this._pt = new fr(this._pt, g, "scaleY", g.scaleY, p ? p * a : a - g.scaleY)), T.push("scaleY", c), (c += "X");
                                else {
                                    if ("transformOrigin" === c) {
                                        (x = void 0),
                                            ...
                                            (x[1] = ai[O] || O),
                                            (o = x.join(" ")),
                                            g.svg ? mi(t, o, 0, v, 0, this) : ((d = parseFloat(o.split(" ")[2]) || 0) !== g.zOrigin && ri(this, g, "zOrigin", g.zOrigin, d), ri(this, M, c, gi(s), gi(o)));
                                        continue;
                                    }
                                    if ("svgOrigin" === c) {
                                        mi(t, o, 1, v, 0, this);
                            ...
                            if (m || ((a || 0 === a) && (u || 0 === u) && !Ar.test(o) && c in M))
                                a || (a = 0),
                                    (f = (s + "").substr((u + "").length)) !== (d = ie(o) || (c in C.units ? C.units[c] : f)) && (u = ni(t, c, s, d)),
                                    (this._pt = new fr(this._pt, m ? g : M, c, u, p ? p * a : a - u, m || ("px" !== d && "zIndex" !== c) || !1 === e.autoRound ? Lr : Rr)),
                                    (this._pt.u = d || 0),
            ...
            getSetter: function (t, e, r) {
                ...
                return (
                    i && i.indexOf(",") < 0 && (e = i),
                    e in Tr && e !== Ur && (t._gsap.x || si(t, "x")) ? (r && br === r ? ("scale" === e ? Nr : jr) : (br = r || {}) && ("scale" === e ? Vr : Xr)) : t.style && !Y(t.style[e]) ? qr : ~e.indexOf("-") ? Br : ir(t, e)
                );
            },
            core: { _removeProperty: ei, _getMatrix: pi },
        };
    (_r.utils.checkPrefix = Gr),
        (Ai = bt((ki = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (Ei = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function (t) {
            Tr[t] = 1;
        })),
        bt(Ei, function (t) {
    ...
    function Ki(t, e, r, i) {
        ...
        if (
            (Zi(r),
            void 0 === (s = t._events) ? ((s = t._events = Object.create(null)), (t._eventsCount = 0)) : (void 0 !== s.newListener && (t.emit("newListener", e, r.listener ? r.listener : r), (s = t._events)), (o = s[e])),
            void 0 === o)
        )
    ...
    class un {
        constructor(t) {
            (this.DOM = { el: t }), (this.renderedStyles = { tx: { previous: 0, current: 0, amt: 0.04 }, ty: { previous: 0, current: 0, amt: 0.04 } }), this.calculateSizePosition(), this.initEvents();
        }
                ...
                this.DOM.el.addEventListener("mouseenter", () => {
                    this.hoverTimeout = setTimeout(() => {
                        const { x: t, y: e } = ((t) => {
                            ...
                            return "2d" === i ? { x: n[4], y: n[5], z: 0 } : "3d" === i ? { x: n[12], y: n[13], z: n[14] } : void 0;
                        })(this.DOM.el);
        ...
        render() {
            ...
            (this.renderedStyles.tx.current = 0.3 * (an.x - (t + this.rect.left + this.rect.width / 2))), (this.renderedStyles.ty.current = 0.3 * (an.y - (e + this.rect.top + this.rect.height / 2)));
            ...
            Ii.set(this.DOM.el, { x: this.renderedStyles.tx.previous, y: this.renderedStyles.ty.previous }), this.loopRender();
        }
    }
    class hn {
        constructor(t) {
    ...
    class fn {
        ...
        layout() {
            ...
            (this.isLeft = t.left + t.width / 2 < ln.width / 2),
                ...
                (this.rY = this.isLeft ? qi(t.left + t.width / 2, 0, ln.width / 2, this.rystart, 0) : qi(t.left + t.width / 2, ln.width / 2, ln.width, 0, -this.rystart)),
                (this.rX = this.isTop ? qi(t.top + t.height / 2, 0, ln.height / 2, -this.rxstart, 0) : qi(t.top + t.height / 2, ln.height / 2, ln.height, 0, this.rxstart)),
                (this.tZ = this.isLeft ? qi(t.left + t.width / 2, 0, ln.width / 2, -200, -600) : qi(t.left + t.width / 2, ln.width / 2, ln.width, -600, -200)),
                Ii.set(this.DOM.el, { rotationX: this.rX, rotationY: this.rY, z: this.tZ });
        }
        onMouseEnter() {
            this.hoverTimeout = setTimeout(() => {
                this.timelineHoverOut && this.timelineHoverOut.kill(), (this.timelineHoverIn = Ii.timeline().addLabel("start", 0).to(this.DOM.image, { duration: 0.8, ease: "expo", scale: 1.1 }, "start"));
            }, 10);
        }
        onMouseLeave() {
            this.hoverTimeout && clearTimeout(this.hoverTimeout), this.timelineHoverIn && this.timelineHoverIn.kill(), (this.timelineHoverOut = Ii.timeline().to(this.DOM.image, { duration: 1, ease: "power4", x: 0, y: 0, scale: 1 }));
        }
        ...
        move() {
            (this.requestId = void 0),
                (this.translationVals.x = Bi(this.translationVals.x, qi(cn.x, 0, ln.width, -this.xstart, this.xstart), 0.04)),
                (this.translationVals.y = Bi(this.translationVals.y, qi(cn.y, 0, ln.height, -this.ystart, this.ystart), 0.04)),
                (this.rotationVals.x = this.isTop ? Bi(this.rotationVals.x, qi(cn.y, 0, ln.height / 2, this.rxstart, 0), 0.04) : Bi(this.rotationVals.x, qi(cn.y, ln.height / 2, ln.height, 0, -this.rxstart), 0.04)),
                (this.rotationVals.y = this.isLeft ? Bi(this.rotationVals.y, qi(cn.x, 0, ln.width / 2, -this.rystart, 0), 0.04) : Bi(this.rotationVals.y, qi(cn.x, ln.width / 2, ln.width, 0, this.rystart), 0.04)),
                Ii.set(this.DOM.el, { x: -this.translationVals.x, y: -this.translationVals.y, rotationX: -this.rX - this.rotationVals.x, rotationY: -this.rY - this.rotationVals.y }),
                this.loopTransformAnimation();
        }
    }
    var dn,
    ...
    class gn extends Yi.EventEmitter {
        ...
        showContent(t) {
            ...
            Ii.timeline()
                .addLabel("start", 0)
                .to(this.DOM.items, { duration: 2, ease: "expo.inOut", opacity: 0, rotationX: 0, rotationY: 0, y: "-=" + Ni(1e3, 1600), stagger: { amount: 0.2, grid: "auto", from: "top" } }, "start")
                .to(_n, { duration: 1.5, ease: "expo.inOut", opacity: 0, y: "-=100%", stagger: 0.03 }, "start+=0.1")
                .add(() => {
                    t.preview.DOM.el.classList.add("preview__item--open");
                }, "start+=0.1")
                .to(t.preview.DOM.titleChars, { duration: 1.5, ease: "expo.inOut", opacity: 1, y: "0%", stagger: 0.05 }, "start+=0.6")
                .to([t.preview.DOM.imgWrap, t.preview.DOM.image], { duration: 1.5, ease: "expo.inOut", opacity: 1, y: "0%", rotationX: 0 }, "start+=0.5")
                .to(t.preview.DOM.imgWrap, { duration: 1.5, ease: "expo.inOut", opacity: 1 }, "start+=0.5")
                .to(t.preview.DOM.backCtrl, { duration: 1.5, ease: "expo", startAt: { x: "20%" }, x: "0%", opacity: 1 }, "start+=1.5")
                .to(t.preview.DOM.content, { duration: 1.5, ease: "expo", startAt: { y: "20%" }, y: "0%", opacity: 1 }, "start+=1.5");
        }
        hideContent(t) {
            if (!this.isContentOpen) return !1;
            (this.isContentOpen = !1),
                Ii.timeline({
                    ...
                    .addLabel("start", 0)
                    .to(t.preview.DOM.titleChars, { duration: 1.5, ease: "expo.inOut", opacity: 0, y: "100%", stagger: -0.04 }, "start")
                    .to(t.preview.DOM.imgWrap, { duration: 1.5, ease: "expo.inOut", y: "100%", rotationX: -20 }, "start")
                    .to(t.preview.DOM.image, { duration: 1.5, ease: "expo.inOut", y: "-100%" }, "start")
                    .to(t.preview.DOM.backCtrl, { duration: 1.5, ease: "expo.inOut", x: "20%", opacity: 0 }, "start")
                    .to(t.preview.DOM.content, { duration: 1.5, ease: "expo.inOut", y: "50%", opacity: 0 }, "start")
                    .to(_n, { duration: 1, ease: "expo.inOut", opacity: 1, y: "0%", stagger: -0.03 }, "start+=0.4")
                    .add(() => {
    ...
    const vn = new (class {
        constructor(t) {
            (this.DOM = { el: t }),
                ...
                (this.onMouseMoveEv = () => {
                    (this.renderedStyles.tx.previous = this.renderedStyles.tx.current = this.renderedStyles.txText.previous = this.renderedStyles.txText.current = Xi.x - this.bounds.width / 2),
                        (this.renderedStyles.ty.previous = this.renderedStyles.ty.current = this.renderedStyles.tyText.previous = this.renderedStyles.tyText.current = Xi.y - this.bounds.height / 2),
                        Ii.to(this.DOM.el, { duration: 0.9, ease: "Power3.easeOut", opacity: 1 }),
